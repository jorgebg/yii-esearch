...
class SearchBoxPortlet extends CPortlet {
	...
	public function init(){
		...
		if($this->cssFile===null && $this->css===null && isset($this->htmlOptions['id']))
			$cs->registerCss($this->htmlOptions['id'].'-css',
				'#'.$this->htmlOptions['id'].' input.search-input { width:65% } '.
				'#'.$this->htmlOptions['id'].' input.search-button { width:25% }'
			);
		else if($this->css)
